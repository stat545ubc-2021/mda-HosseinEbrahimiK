...
**NOTE**: Below I included a modified code for one of the plots in milestone 2. The original code was handling the orders of a categorical variable without me noticing it. I changed the code in a way that orders are not correct automatically.
...
Now let's see how this relation changes for different type of tree. The bigger the age coefficient value, the stronger relation between age and diameter.
